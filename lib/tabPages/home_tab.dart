import 'dart:async';
import 'package:uberdrivernew/assistants/assistant_methods.dart';
import 'package:uberdrivernew/global/global.dart';
import 'package:uberdrivernew/push_notifications/push_notification_system.dart';
...
class HomeTabPage extends StatefulWidget {
  ...
  const HomeTabPage({Key? key, this.email, this.password}) : super(key: key);
...
class _HomeTabPageState extends State<HomeTabPage> {
  ...
  locateDriverPosition(context) async {
  ...
  readCurrentDriverInformation() async {
    /*Map<String, dynamic>? user =
        await MongoDatabase.checkDriverisValid(widget.email, widget.password);

    Map<String, dynamic>? car =
        await MongoDatabase.checkCarIsValid(widget.email);

    debugPrint("user : ${user.toString()}");
    debugPrint("car : ${car.toString()}");

    onlineDriverData.id = user!['_id'];
